...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(CustomCallOut), factory.CustomCallOut);
		dict.Add(typeof(CustomCallRef), factory.CustomCallRef);
		dict.Add(typeof(CustomCallParams), factory.CustomCallParams);
		...
		DelegateTraits<CustomCallOut>.Init(factory.CustomCallOut);
		DelegateTraits<CustomCallRef>.Init(factory.CustomCallRef);
		DelegateTraits<CustomCallParams>.Init(factory.CustomCallParams);
		...
		TypeTraits<CustomCallOut>.Init(factory.Check_CustomCallOut);
		TypeTraits<CustomCallRef>.Init(factory.Check_CustomCallRef);
		TypeTraits<CustomCallParams>.Init(factory.Check_CustomCallParams);
		...
		StackTraits<CustomCallOut>.Push = factory.Push_CustomCallOut;
		StackTraits<CustomCallRef>.Push = factory.Push_CustomCallRef;
		StackTraits<CustomCallParams>.Push = factory.Push_CustomCallParams;
	...
	class CustomCallOut_Event : LuaDelegate
	{
		public CustomCallOut_Event(LuaFunction func) : base(func) { }
		public CustomCallOut_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public int Call(int param0, out int param1, out bool param2, out string param3, out int param4)
		{
			func.BeginPCall();
			func.Push(param0);
			func.PCall();
			int ret = (int)func.CheckNumber();
			param1 = (int)func.CheckNumber();
			param2 = func.CheckBoolean();
			param3 = func.CheckString();
			param4 = (int)func.CheckNumber();
			func.EndPCall();
			return ret;
		}

		public int CallWithSelf(int param0, out int param1, out bool param2, out string param3, out int param4)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public CustomCallOut CustomCallOut(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			CustomCallOut fn = delegate(int param0, out int param1, out bool param2, out string param3, out int param4) 
			{
				param1 = 0;
				param2 = false;
				param3 = null;
		...
		if(!flag)
		{
			CustomCallOut_Event target = new CustomCallOut_Event(func);
			CustomCallOut d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			CustomCallOut_Event target = new CustomCallOut_Event(func, self);
			CustomCallOut d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_CustomCallOut(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(CustomCallOut), L, pos);
	}

	void Push_CustomCallOut(IntPtr L, CustomCallOut o)
	{
		ToLua.Push(L, o);
	}

	class CustomCallRef_Event : LuaDelegate
	{
		public CustomCallRef_Event(LuaFunction func) : base(func) { }
		public CustomCallRef_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public int Call(int param0, ref int param1, ref bool param2, ref string param3, ref int param4)
		{
			func.BeginPCall();
			func.Push(param0);
		...
		public int CallWithSelf(int param0, ref int param1, ref bool param2, ref string param3, ref int param4)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public CustomCallRef CustomCallRef(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			CustomCallRef fn = delegate(int param0, ref int param1, ref bool param2, ref string param3, ref int param4) { return 0; };
			return fn;
		}

		if(!flag)
		{
			CustomCallRef_Event target = new CustomCallRef_Event(func);
			CustomCallRef d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			CustomCallRef_Event target = new CustomCallRef_Event(func, self);
			CustomCallRef d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_CustomCallRef(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(CustomCallRef), L, pos);
	}

	void Push_CustomCallRef(IntPtr L, CustomCallRef o)
	{
		ToLua.Push(L, o);
	}

	class CustomCallParams_Event : LuaDelegate
	{
		public CustomCallParams_Event(LuaFunction func) : base(func) { }
		public CustomCallParams_Event(LuaFunction func, LuaTable self) : base(func, self) { }
		...
		public void CallWithSelf(int param0, object[] param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public CustomCallParams CustomCallParams(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			CustomCallParams fn = delegate(int param0, object[] param1) { };
			return fn;
		}

		if(!flag)
		{
			CustomCallParams_Event target = new CustomCallParams_Event(func);
			CustomCallParams d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			CustomCallParams_Event target = new CustomCallParams_Event(func, self);
			CustomCallParams d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_CustomCallParams(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(CustomCallParams), L, pos);
	}

	void Push_CustomCallParams(IntPtr L, CustomCallParams o)
	{
		ToLua.Push(L, o);
	}
