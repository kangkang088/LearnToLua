...
public class Lesson7Wrap
{
	...
	static int get_del(IntPtr L)
	{
		...
		try
		{
			...
			UnityEngine.Events.UnityAction ret = obj.del;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index del on a nil value");
		}
	}
